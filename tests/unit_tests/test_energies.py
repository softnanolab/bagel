...
def test_SeparationEnergyNonLinear(
    ...
    assert np.isclose(unweighted_energy, 0.0), f'unweighted energy is incorrect, 0 expected below harmonic cutoff but found {unweighted_energy}'
    assert np.isclose(weighted_energy, 0.0), f'weighted energy is incorrect, 0 expected below harmonic cutoff but found {weighted_energy}'
    ...
    assert np.isclose(unweighted_energy, 1.0/8.0), f'unweighted energy is incorrect, {1.0/8.0} expected but found {unweighted_energy}'
    assert np.isclose(weighted_energy, 1.0/4.0), f'weighted energy is incorrect, {1.0/4.0} expected but found {weighted_energy}'
    ...
    assert np.isclose(unweighted_energy, 0.5), f'unweighted energy is incorrect, 0.5 expected at x0 but found {unweighted_energy}'
    assert np.isclose(weighted_energy, 1.0), f'weighted energy is incorrect, 1.0 expected at x0 but found {weighted_energy}'
    ...
    assert np.isclose(unweighted_energy, value), f'unweighted energy is incorrect, {value} expected but found {unweighted_energy}'
    assert np.isclose(weighted_energy, 2.0 * value), f'weighted energy is incorrect, {2.0 * value} expected but found {weighted_energy}'
...
def test_LISEnergy(
    ...
    assert np.isclose(unweighted_energy, expected), f'unweighted energy is incorrect, expected 0.5, found {unweighted_energy}'
    assert np.isclose(weighted_energy, 2.0*expected), f'weighted energy is incorrect, expected {2.0*expected}, found {weighted_energy}'
