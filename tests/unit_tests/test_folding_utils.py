...
def test_reorder_skips_non_protein_residues() -> None:
    ...
    unique_residues_before = {(int(res_id), chain_id, res_name) for res_id, chain_id, res_name in zip(structure.res_id, structure.chain_id, structure.res_name)}
    ...
    unique_residues_after = {(int(res_id), chain_id, res_name) for res_id, chain_id, res_name in zip(reordered.res_id, reordered.chain_id, reordered.res_name)}
