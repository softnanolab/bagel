...
def test_pLM_sampling_early_stopping_stops_on_plateau(plm_only_state: bg.State, test_output_path: pl.Path) -> None:
    ...
    early_stop = bg.callbacks.EarlyStopping(monitor='system_energy', patience=50, mode='min')
