...
lower values of that feature combination.

Because BAGEL minimizes energy:

- a **positive** coefficient (default) designs *away* from a feature's concept;
- a **negative** coefficient designs *toward* it.
...
[ESM Atlas feature API](https://biohub.ai) to look up what concept each feature
encodes.
